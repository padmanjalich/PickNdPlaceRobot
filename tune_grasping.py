...
def main():
    ...
    handInitial = [0.22758715119487366, 0.9757903273209749, 0.24161750372834237, 0.22710371244591762, 0.976509480725665,
                   0.18225672671637788, 0.5776262116231128, 0.5856521577290977, 0.21449415241902586, 0.573393395852755,
                   0.5911037708666577, 0.1700040673710855, 0.9352621390539142, 0.26659978467036205, 0.1700028233065044,
                   0.9354455405240106, 0.26708167250766834, 0.16999999999999985, 0.9059983743861906,
                   0.25177778770414255, 0.1699999881540996, 0.9058464398347609, 0.25171720259452235,
                   0.16999998371672256, 1.5697207347951239, 0.3404695043046988, 0.34043465669512]
    orientation = [1.2892775535583496, 2.827588395276342, 1.2237756252288818]
    # palmPosition = [1.04,-0.03,0.38]
    palmPosition = [0.95, 0, 0.2]

    environment = sawyerEnv(renders=True, isDiscrete=False, maxSteps=10000000, palmPosition=palmPosition,
